// used to display messages in the <pre>
function log() {
...
// to use BFF user management endpoint to query if user is logged in or not
let userClaims = null;
...
// need to redirect user to BFF logout endpoint - requires anti-forgery to prevent cross site request forgery attacks
// thus full logout URL is in bff:logout_url
function logout() {
    if (userClaims) {
